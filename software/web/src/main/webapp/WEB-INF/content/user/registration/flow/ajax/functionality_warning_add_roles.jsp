...
<div id="tabwrapper">
    <div class="ui-tabs">
        <div class="ui-tabs-panel">
            <firebird:dialogHeader><fmt:message key="user.add.roles.functionality.warning.title"/></firebird:dialogHeader>
            <p><fmt:message key="user.add.roles.functionality.warning.subtext"/></p>

            <s:iterator value="unverifiedRoles" var="role">
                <h3><s:property value="#this.display"/></h3>
                <div class="richText clear">
                    <s:property value="%{getText('user.add.roles.functionality.warning.' + #this.name())}" escapeHtml="false"/>
                </div>
            </s:iterator>

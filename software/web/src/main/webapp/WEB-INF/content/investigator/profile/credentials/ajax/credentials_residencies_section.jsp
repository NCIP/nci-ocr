...
<s:url action="manageResidencyCredentials" var="manageResidencyUrl">
    <s:param name="profile.id" value="%{profile.id}" />
</s:url>

<sj:a openDialog="profileDialog" href="%{manageResidencyUrl}" cssClass="addCredential" id="createNewResidency"><fmt:message key="button.add.residency"/></sj:a>
<table id="residenciesTable" class="ui-jqgrid-htable ui-jqgrid-btable"
       summary="This table contains all of the residencies that have been entered for the profile. It displays the 
                certifying board, the specialty, where the residency took place, the start date, when it ended (if necessary), 
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var baseUrl = '<s:property value="manageResidencyUrl"/>';

...
<div id="financialDisclosureTab" class="ctepFinancialDisclosure"><!-- Marker that this is the CTEP Financial Disclosure Tab -->
    ...
    <s:if test="readOnly">
        ...
        <div class="formcol_row">
            <h2>
                <fmt:message key="annual.registration.financial.disclosure.supporting.documents"/>
            </h2>
        </div>
        <br/>
        ...
        <script type='text/javascript'>
            ...
            function createDeleteLink(pharmaceuticalCompany) {
              ...
              return ajaxLinkFormatter(createImage('ico_delete.gif', 'Delete'),
                      {
                          'url': url,
                          'paramName':'pharmaceuticalCompanyExternalId',
